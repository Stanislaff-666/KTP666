/** Простое Свинг приложение, которое обеспечивает редатируемый вид 2Д-карты, и запускает поиск пути по запросу**/
import java.awt.*;
...
public class AStarApp {
     ...
     * that was performed.mplements это ключевое слово, предназначенное для реализации интерфейса (interface).
     implements означает, что Вы используете элементы интерфейса в Вашем классе
     **/
